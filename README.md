...
- 🥼 현재 KAIST DIS Lab에서 **AI Co-Scientist** 주제로 연구 인턴을 진행 중
- 🔭 **Blitz-Dynamics**에서 산학협력 DevOps(& Data Engineering) 인턴으로 근무 
...
| 빡공팟(P4C) 1기 개인정보보호 트랙 | **ELITE 3 (TOP 3)** 우수 수료 | 2026.03 |
